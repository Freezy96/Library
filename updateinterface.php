		...
		<div class="container well">
			...
			<div class="col-md-8">
				...
				<table class="table">
					<tr>
						<th><h4>ISBN</h4></th>
						<td><h4><input name="isbn" class="form-control" type="text" required="required" value="<?php echo $row['isbn'] ?>"></input></h4></td>
					</tr>
					<tr>
						<th><h4>Title</h4></th>
						<td><h4><input name="title" class="form-control" type="text" required="required" value="<?php echo $row['title'] ?>"></input></h4></td>
					</tr>
					<tr>
						<th><h4>Author</h4></th>
						<td><h4><input name="author" class="form-control" type="text" required="required" value="<?php echo $row['author'] ?>"></input></h4></td>
					</tr>
					<tr>
						<th><h4>Publisher</h4></th>
						<td><h4><input name="publisher" class="form-control" type="text" required="required" value="<?php echo $row['publisher'] ?>"></input></h4></td>
					</tr>
					<tr>
						<th><h4>Description</h4></th>
						<td><h4><textarea name="description" class="form-control" rows="5" cols="50" required="required"><?php echo $row['description'] ?></textarea></h4></td>
					</tr>
